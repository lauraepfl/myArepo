...
#ifeq ($(SYSTYPE),"Ubuntu")
CC        =  mpicc
### by MP to include Barros profiles 
FC        =  mpif90  # sets the C-compiler
FCFLAGS   = -O3
###
# compiler and its optimization options
OPTIMIZE  =  -std=c11 -ggdb -O3 -Wall -Wno-format-security -Wno-unknown-pragmas -Wno-unused-function
...
ifeq (BARROS,$(findstring BARROS,$(CONFIGVARS)))
OBJS    += fortran/gravity/barros.o
SUBDIRS += fortran
SUBDIRS += fortran/gravity
